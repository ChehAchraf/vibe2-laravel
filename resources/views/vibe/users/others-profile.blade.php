                    ...
                    <div class="bg-white rounded-lg shadow">
                        <div class="p-4">
                            <div class="flex items-center space-x-4">
                                <img src="{{ asset('storage/' . $post->user->profile_photo) }}" class="w-10 h-10 rounded-full">
                                <div>
                            ...
                            @if($post->image)
                                <img src="{{ asset('storage/' . $post->image) }}" class="mt-4 rounded-lg w-full">
                            @endif
                            ...
                            <div class="flex items-center justify-between mt-4 text-gray-500 text-sm">
                                ...
                                <div>
                                    <span>{{ $post->comments()->count() }} Comments · 4 Shares</span>
                                </div>
                            </div>
