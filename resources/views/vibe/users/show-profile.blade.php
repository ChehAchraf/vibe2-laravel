...
<div class="relative">
    ...
    <div class="h-96 w-full overflow-hidden">
        <img src="https://via.placeholder.com/1920x1080" alt="Cover Photo" class="w-full object-cover h-full">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="-mt-24 sm:-mt-32 sm:flex sm:items-end sm:space-x-5">
            <div class="relative group">
                <img class="h-48 w-48 rounded-full ring-4 ring-white object-cover" src="https://via.placeholder.com/200" alt="Profile Picture">
